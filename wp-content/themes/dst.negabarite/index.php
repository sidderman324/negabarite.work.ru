...
<section class="service">
  <div class="container service__inner">
    ...
    <div class="service__item-wrapper">
      <a href="/service/remont-dorog<?= $gorod ?>/" class="service-card">
      ...
      <a href="/service/stroitelstvo-dorog<?= $gorod ?>/" class="service-card">
        <div class="service-card__img-wrapper">
      ...
      <a href="/service/stroitelstvo-nefteprovodov<?= $gorod ?>/" class="service-card">
        <div class="service-card__img-wrapper">
      ...
      <a href="/service/stroitelstvo-gazoprovodov<?= $gorod ?>/" class="service-card">
        <div class="service-card__img-wrapper">
      ...
      <a href="/service/otsypka-dorog<?= $gorod ?>/" class="service-card">
        <div class="service-card__img-wrapper">
