      ...
      <div class="container">
        ...
        <div class="promo__text-box">
          ...
          <div class="promo__btn-wrapper">
            ...
            <a href="/arenda-ekskavatorov/" class="promo__btn promo__btn--yellow">Арендовать</a>



            <a href="/katalog-tehniki/" class="promo__btn">Каталог спецтехники</a>
...
<section class="trall">
  ...
  <div class="container trall__inner">
    ...
    <a href="http://www.negabarite.com/" class="trall__btn">Перевозка негабаритных грузов</a>
...
<section class="about">
  ...
  <div class="container about__inner">
    ...
    <div class="about__text-wrapper">
      ...
      <a href="/sdat-tehniku-v-arendu/" class="about__btn">Сотрудничество</a>
...
<section class="catalog" id="catalog">
  ...
  <div class="container catalog__inner">
    ...
    <div class="catalog__btn-wrapper">
      ...
      <a href="#" class="catalog__btn catalog__btn--yellow btn_popup">Заказать</a>
...
<section class="service">
  ...
  <div class="container service__inner">
    ...
    <a href="#" class="service__btn btn_popup">Заказать услугу</a>
